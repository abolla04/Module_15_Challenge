    ...
    if age is not None:
        ...
        if age <= 0:
            return build_validation_result(
                False,
                "age",
                "Your age is not valid. Please enter your correct age.",
            )
        elif age >= 65:
            return build_validation_result(
                False,
                "age",
                "The maximum age for this program is 64. Please enter another age.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount for this program is $5,000. Please enter a qualifying amount.",
            )
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        # Once slots are valid, a delegate dialog is returned to Lex to choose the next course of action.
